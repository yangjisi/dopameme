...
const videoLibrary = [
  { id: 1, prompt: '회의실에서 고양이가 스트레칭하기', youtubeId: 'DcuPI2HDvQs' },
  { id: 2, prompt: '지하철에서 개가 짖기', youtubeId: 'a89T38q1eao' },
  { id: 3, prompt: '펍에서 펭귄이 미끄러지기', youtubeId: 'P7fIK0Zu9A0' },
  { id: 4, prompt: '백화점에서 사자가 포효하기', youtubeId: 'S4q69KySzXQ' },
  { id: 5, prompt: '도서관에서 앵무새가 헤드뱅잉하기', youtubeId: 'DcuPI2HDvQs' },
  { id: 6, prompt: '웨딩홀에서 원숭이가 옆돌기', youtubeId: 'DcuPI2HDvQs' },
  { id: 7, prompt: '공원에서 백조가 목을 펴기', youtubeId: 'DcuPI2HDvQs' },
  { id: 8, prompt: '병원에서 돌고래가 점프하기', youtubeId: 'DcuPI2HDvQs' },
  { id: 9, prompt: '영화관에서 너구리가 손을 비비기', youtubeId: 'DcuPI2HDvQs' },
  { id: 10, prompt: '운동장에서 독수리가 날개짓하기', youtubeId: 'DcuPI2HDvQs' },
  { id: 11, prompt: '사무실에서 거북이가 기어가기', youtubeId: 'HYCGIFmJ1LE' },
  { id: 12, prompt: '버스에서 고양이가 스트레칭하기', youtubeId: 'DcuPI2HDvQs' },
  { id: 13, prompt: '콘서트홀에서 개가 짖기', youtubeId: 'DcuPI2HDvQs' },
  { id: 14, prompt: '골프장에서 사자가 포효하기', youtubeId: 'DcuPI2HDvQs' },
  { id: 15, prompt: '카페에서 앵무새가 헤드뱅잉하기', youtubeId: 'DcuPI2HDvQs' },
  { id: 16, prompt: '소방서에서 재미있게 웃기', youtubeId: 'DcuPI2HDvQs' },
  { id: 17, prompt: '학교에서 신나서 쇼핑하기', youtubeId: 'DcuPI2HDvQs' },
  { id: 18, prompt: '장례식장에서 거북이가 기어가기', youtubeId: 'DcuPI2HDvQs' },
  { id: 19, prompt: '놀이공원에서 열심히 운동하기', youtubeId: 'DcuPI2HDvQs' },
  { id: 20, prompt: '박물관에서 독수리가 날개짓하기', youtubeId: 'DcuPI2HDvQs' },
];
            ...
            >
              <div className="relative w-full h-full mx-auto bg-gray-900 rounded-2xl overflow-hidden border border-gray-800">
                ...
                <motion.button
                  ...
                  className={`absolute top-3 left-3 px-3 py-2 rounded-full text-sm font-bold z-20 ${
                    isSpinning
